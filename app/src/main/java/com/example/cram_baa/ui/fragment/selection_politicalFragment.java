 ...
 */
public class selection_politicalFragment extends Fragment {
    private ListView lv_political;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_selection_political,container,false);
    }
    ...
    public void initView(){
        lv_political= (ListView) getView().findViewById(R.id.lv_political);
        hashMap=new HashMap<>();
        for (int i=0;i<6;i++){
        ...
        lv_political.setAdapter(adapterSelection);
    }
}
