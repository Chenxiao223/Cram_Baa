 ...
 */
public class selection_physicsFragment extends Fragment {
    private ListView lv_physics;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_selection_physics,container,false);
    }
    ...
    public void initView(){
        lv_physics= (ListView) getView().findViewById(R.id.lv_physics);
        hashMap=new HashMap<>();
        for (int i=0;i<6;i++){
        ...
        lv_physics.setAdapter(selectionAdapter);
    }
}
