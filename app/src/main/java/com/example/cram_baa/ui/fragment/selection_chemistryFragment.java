 ...
 */
public class selection_chemistryFragment extends Fragment {
    private ListView lv_chemistry;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_selection_chemistry,container,false);
    }
    ...
    public void initView(){
        lv_chemistry= (ListView) getView().findViewById(R.id.lv_chemistry);
        hashMap=new HashMap<>();
        for (int i=0;i<6;i++){
        ...
        lv_chemistry.setAdapter(selectionAdapter);
    }
}
