 ...
 */
public class selection_mathFragment extends Fragment {
    private ListView lv_math;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_selection_math,container,false);
    }
    ...
    public void initView(){
        lv_math= (ListView) getView().findViewById(R.id.lv_math);
        hashMap=new HashMap<>();
        for (int i=0;i<6;i++){
        ...
        lv_math.setAdapter(selectionAdapter);
    }
}
