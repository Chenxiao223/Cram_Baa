...
public class SYBViewPager extends LinearLayout {
	...
	private List<SYBViewPagerCotroller> data;// 原始数据
	...
	public SYBViewPager(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context);
	}

	public SYBViewPager(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
		...
		getViewTreeObserver().addOnGlobalLayoutListener(
				new OnGlobalLayoutListener() {
					...
					public void onGlobalLayout() {
						// 现在布局全部完成，可以获取到任何View组件的宽度和高度、左边和右边等信息
	 ...
	 * 设置界面
	 */
	public synchronized void setViews(List<SYBViewPagerCotroller> viewdatas,
			int defcurrindex) {
		data = viewdatas;
	...
	private class MyViewPagerAdapter extends PagerAdapter {
		...
		public MyViewPagerAdapter(List<SYBViewPagerCotroller> mListViews) {
